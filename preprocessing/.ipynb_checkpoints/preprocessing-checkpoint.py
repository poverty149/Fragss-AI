...
def extract_frames(video_path, output_dir, resize_dim=(224, 224), normalize=False,skip=1):
    """
...
def main():
    ...
    resize_dim = (224, 224)
    skip=1 # extract every nth frame, skipping the rest

    frame_paths = extract_frames(video_path, output_dir, resize_dim,skip)
